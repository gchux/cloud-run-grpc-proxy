...
func main_codegen() {
	...
	/*
		pkgWhitelist.Add("google.datastore.admin.v1")
		pkgWhitelist.Add("google.datastore.admin.v1beta1")
		pkgWhitelist.Add("google.datastore.v1")
		pkgWhitelist.Add("google.datastore.v1beta3")
	*/
	pkgWhitelist.Add("google.spanner.admin.database.v1")
	pkgWhitelist.Add("google.spanner.admin.instance.v1")
	pkgWhitelist.Add("google.spanner.v1")
	pkgWhitelist.Add("google.spanner.executor.v1")
